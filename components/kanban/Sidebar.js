  ...
  return (
    <div>
      <div
        className={
          isSideBarOpen
            ? `text-black min-w-[261px] bg-white dark:bg-[#2b2c37]  fixed top-[72px] h-screen  items-center left-0 z-20`
        ...
        <div>
          ...
          {isSideBarOpen && (
            <div className=" bg-white  dark:bg-[#2b2c37]    w-full   py-4 rounded-xl">
              ...
              <div className="  dropdown-borad flex flex-col h-[70vh]  justify-between ">
                ...
                <div className=" my-14 mx-2  p-4 relative space-x-2 bg-slate-100 dark:bg-[#20212c] flex justify-center items-center rounded-lg">
                  <img
          ...
          {isSideBarOpen ? (
            ...
            <div className=" absolute p-5  " onClick={() => toggleSidebar()}>
              <img src={"/assets/icons/icon-show-sidebar.svg"} alt="img" />
            </div>
          )}
        </div>
      </div>
